...
public class EmpleadoController {
    ...
    public static void crearEmpleado(){
        ...
        Empleado nuevoEmpleado = new Empleado(nombreUsuario, password, apellidos, direccion, telefono);  
    }
    ...
    public static Empleado leerDomEmpleado(NodeList datosEmpleado){
        ...
        Empleado empleado = new Empleado(nombreUsuario, password, apellidos,direccion, telefono);
